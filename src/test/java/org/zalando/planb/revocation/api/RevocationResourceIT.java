...
public class RevocationResourceIT extends AbstractSpringTest {
    ...
    public void testGetEmptyRevocations() {
        ResponseEntity<RevocationInfo> response = restTemplate.exchange(get(
                URI.create(basePath() + "/revocations?from=" + InstantTimestamp.FIVE_MINUTES_AGO.seconds())).build(), RevocationInfo.class);
    ...
    public void testGetRefreshFromInMeta() {
        ...
        System.out.println(basePath() + "/revocations?from=" + InstantTimestamp.FIVE_MINUTES_AGO.seconds());

        ResponseEntity<RevocationInfo> response = restTemplate.exchange(get(
                URI.create(basePath() + "/revocations?from=" + (InstantTimestamp.FIVE_MINUTES_AGO.seconds())))
                .build(),
                RevocationInfo.class);
        RevocationInfo responseBody = response.getBody();
    ...
    public void testInsertRevocation() {
        ...
        Collection<StoredRevocation> storedRevocations = revocationStore.getRevocations(InstantTimestamp
                .FIVE_MINUTES_AGO.seconds());
    ...
    public void testTimestampNotTooOldOnGet() {
        ...
        long notTooOldTimeStamp = InstantTimestamp.NOW.seconds() - cassandraProperties.getMaxTimeDelta() + 1;
